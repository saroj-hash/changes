                ...
                <Row>
                    {
                        ...
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <Button className=" col-md-8 btn btn-block" disabled={!this.state.formValid.buttonActive} onClick={this.handleSubmit}>
                                <Badge variant="dark" style={{ backgroundColor: "orange" }}>
                    ...
                    <div className="offset-md-1 col-md-5">
                        ...
                        <Tooltip title="Go directly to blogs" placement="top" arrow>
                            ...
                            <div>
                                <Row>
                                    <Button className="btn btn-block" onClick={this.handleBack}>
                                        <h4>
                                        <Badge variant="dark" style={{backgroundColor:"orange"}}>
                                            Wanna Try again?
                                        </Badge>
